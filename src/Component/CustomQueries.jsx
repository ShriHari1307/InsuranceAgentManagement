                ...
                >
                  ...
                  <tbody>
                    {queryResults.data && queryResults.data.length > 0 ? (
                      queryResults.data.map((provider, index) => (
                        <tr key={index}>
                          <td>{provider.providerName || "No data found"}</td>
                          <td>{provider.agentFirstName || "No data found"}</td>
                          <td>{provider.providerEmail || "No data found"}</td>
                          <td>{provider.agentLastName || "No data found"}</td>
                          <td>{provider.agentEmail || "No data found"}</td>
                        </tr>
                      ))
                    ) : (
                      <tr>
